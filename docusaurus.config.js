...
const config = {
  ...
  tagline: 'Com o Pizzi presente, viajar é para sempre',
  ...
  organizationName: 'LuisConceicao85213', // Usually your GitHub org/user name.
  projectName: 'ADC_TP3', // Usually your repo name.
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Segunda a Sexta: 9:00 - 18:00 ' ,
                to: '/',
              },
              {
                label: 'Sábado: 9:00 - 15:00',
                to: '/',
              },
              {
                label: 'Domingo: Folga',
